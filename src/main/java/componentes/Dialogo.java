...
public class Dialogo extends JDialog implements ActionListener, MouseListener, MouseMotionListener {
    ...
    public Dialogo(JFrame ventana, Dimension dimension, JPanel lamnina) {

        super(ventana, true);
        this.ventana = ventana;
        this.setUndecorated(true);
        this.setSize(dimension.width, dimension.height + (int) (ventana.getSize().height * 0.05));
