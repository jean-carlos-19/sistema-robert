...
public class HistorialCuentaGui extends JPanel {
    ...
    public HistorialCuentaGui(Dimension d) {

        this.setLayout(null);
        this.setLocation(0, 0);
        this.setSize((int) (d.getWidth() * 0.9), (int) (d.getHeight() * 0.45));
        this.datos = Consultas.getConsultas().getUsuarioCons().buscar(1, null);
        this.atributos();
        this.cuadroTexto();
    }
    ...
    private void obtenerdatos(int codigo,String buscar) {
		...
		this.modelo.setModelo(new String[] { "codigo", "empleado", "cargo", "cuenta" }, this.datos );
    ...
    private void atributos() {
        ...
        this.modelo = new Modelo(new String[] { "codigo", "empleado", "cargo", "cuenta" }, this.datos);
    ...
    private class eventoTeclado extends KeyAdapter {
        ...
        public void keyReleased(KeyEvent arg0) {
            ...
            if (CuadroTexto.getText().equalsIgnoreCase("")) {
            	...
            	obtenerdatos(3, CuadroTexto.getText());
            }
