...
public class PagoDeudaGui extends JPanel {
	...
	public PagoDeudaGui(Dimension d, int opcion) {
		this.setLayout(null);
	...
	public void atributos(int opcion) {
		...
		this.opcion = opcion;
		this.modelo = new Modelo(new String[] { "cedula", "cliente", "direccion", "telefono", "pago", "detalle" },
				new String[][] { { "1" } });
