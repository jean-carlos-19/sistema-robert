...
public class ComprasGui extends JPanel {
	...
	public ComprasGui(Dimension d, int opcion) {

		this.setLayout(null);
		this.setLocation(0, 0);
		this.setSize((int) (d.getWidth() * 0.90), (int) (d.getHeight() * 0.45));
		this.datos = Consultas.getConsultas().getComprasCons().busqueda(1,null);
	...
	public void atributos(int opcion) {
		...
		this.opcion = opcion;
		this.modelo = new Modelo(new String[] { "codigo", "proveedor", "fecha", "iva", "subtotal", "total", "detalle" },
				this.datos);
